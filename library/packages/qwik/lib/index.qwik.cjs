...
const AutoComplete = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesScopedQrl(/* @__PURE__ */ qwik.inlinedQrl(STYLES$1, "AutoComplete_component_useStylesScoped_F8KMepxfXd4"));
  ...
  return /* @__PURE__ */ qwik._jsxQ("div", null, {
    ...
    state.suggestions.length > 0 && state.showSuggestions ? /* @__PURE__ */ qwik._jsxQ("ul", null, {
      ...
      return /* @__PURE__ */ qwik._jsxQ("li", {
        ...
        item
      }, 3, "Ea_0") : /* @__PURE__ */ qwik._jsxQ("span", null, null, transform(props, state, item), 1, null), 0, idx);
    }), 1, "Ea_1") : null
  ], 1, "Ea_2");
...
const TodoApp = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesScopedQrl(/* @__PURE__ */ qwik.inlinedQrl(STYLES, "TodoApp_component_useStylesScoped_yFK00By1ZJg"));
  const state = qwik.useStore({
    list: [
      "hello",
      "world"
